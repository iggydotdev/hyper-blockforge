...
## Environments
- Preview: https://main--hyper-blockforge--iggydotdev.aem.page/
- Live: https://main--hyper-blockforge--iggydotdev.aem.live/
...
1. Open the `hyper-blockforge` directory in your favorite IDE and start coding :)
